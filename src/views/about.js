...
export function renderAbout() {
    ...
    <section>
        ...
        <video class="video-marvel-inico" autoplay muted loop playsinline> <source src="./src/assets/videos/deadpoolvideo.mp4">
        ...
        <p class = "texto-superhero">Esta desfiguración es el resultado de un cáncer terminal
        ...
        <p class = "texto-superhero">Su rasgo físico más imponente 
        ...
        <video class="video-marvel-inico" autoplay muted loop playsinline> 
        ...
        <p class = "texto-superhero">Venom se transforma en una masa imponente de más de 
